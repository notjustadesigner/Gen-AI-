  ...
  return (
    <div className="info-modal-overlay" onClick={onClose}>
      <div className="info-modal-box" onClick={(e) => e.stopPropagation()}>
        ...
        <p>
          Generation[AI] is an open-data visual storytelling project that
          explores a simple but urgent question:
          <br />
          <b>How are students using AI—and why isn’t school keeping up?</b>
        </p>
        <p>
          From ChatGPT to Grammarly to Midjourney, AI tools are already deeply
          woven into students' learning routines.
          <br />
        ...
        <ul>
          <li>What does academic integrity mean in the age of AI?</li>
          <li>
            How do students actually use AI—creatively, strategically, or just
            to survive?
          </li>
          <li>And most importantly: why is education stuck in the past?</li>
        </ul>
        <h2>Who made this?</h2>
        <p>
          ...
          <br />
          in collaboration with Flashka, an experimental collective focused on
        ...
        <p>
          ...
          <br />
          Your 2-minute survey response becomes part of an open conversation—and
